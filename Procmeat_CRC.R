...
#RR dose-response
r <- mcstoc(rpert, type = "U", min = 0.002, mode = 0.0036, max = 0.0056) #1.18, 95% CI: 1.10-1.28 converted to RR/g/day (WCRF/AICR CUP SLR 2011)
...
set.seed(1)
ifexp <- mcstoc(rempiricalD, values = c(0,1), prob = c(probproc15_19m[,1],probproc15_19m[,2]))
exp <- mcstoc(rgamma, type = "V", fit2_15_19m$estimate[1], fit2_15_19m$estimate[2], rtrunc = T, linf = 0, lsup = 500)
...
set.seed(1)
ifexp <- mcstoc(rempiricalD, values = c(0,1), prob = c(probproc_alt15_19m[,1],probproc_alt15_19m[,2]))
exp <- mcstoc(rgamma, type = "V", fit2_alt_15_19m$estimate[1], fit2_alt_15_19m$estimate[2], rtrunc = T, linf = 0, lsup = 500)
...
set.seed(1)
ifexp <- mcstoc(rempiricalD, values = c(0,1), prob = c(probproc20_24m[,1],probproc20_24m[,2]))
exp <- mcstoc(rgamma, type = "V", fit2_20_24m$estimate[1], fit2_20_24m$estimate[2], rtrunc = T, linf = 0, lsup = 500)
...
set.seed(1)
ifexp <- mcstoc(rempiricalD, values = c(0,1), prob = c(probproc_alt20_24m[,1],probproc_alt20_24m[,2]))
exp <- mcstoc(rgamma, type = "V", fit2_alt_20_24m$estimate[1], fit2_alt_20_24m$estimate[2], rtrunc = T, linf = 0, lsup = 500)
...
set.seed(1)
ifexp <- mcstoc(rempiricalD, values = c(0,1), prob = c(probproc25_29m[,1],probproc25_29m[,2]))
exp <- mcstoc(rgamma, type = "V", fit2_25_29m$estimate[1], fit2_25_29m$estimate[2], rtrunc = T, linf = 0, lsup = 500)
...
set.seed(1)
ifexp <- mcstoc(rempiricalD, values = c(0,1), prob = c(probproc_alt25_29m[,1],probproc_alt25_29m[,2]))
exp <- mcstoc(rgamma, type = "V", fit2_alt_25_29m$estimate[1], fit2_alt_25_29m$estimate[2], rtrunc = T, linf = 0, lsup = 500)
...
set.seed(1)
ifexp <- mcstoc(rempiricalD, values = c(0,1), prob = c(probproc15_19w[,1],probproc15_19w[,2]))
exp <- mcstoc(rgamma, type = "V", fit2_15_19w$estimate[1], fit2_15_19w$estimate[2], rtrunc = T, linf = 0, lsup = 500)
...
set.seed(1)
ifexp <- mcstoc(rempiricalD, values = c(0,1), prob = c(probproc_alt15_19w[,1],probproc_alt15_19w[,2]))
exp <- mcstoc(rgamma, type = "V", fit2_alt_15_19w$estimate[1], fit2_alt_15_19w$estimate[2], rtrunc = T, linf = 0, lsup = 500)
...
set.seed(1)
ifexp <- mcstoc(rempiricalD, values = c(0,1), prob = c(probproc30_34w[,1],probproc30_34w[,2]))
exp <- mcstoc(rgamma, type = "V", fit2_30_34w$estimate[1], fit2_30_34w$estimate[2], rtrunc = T, linf = 0, lsup = 500)
...
set.seed(1)
ifexp <- mcstoc(rempiricalD, values = c(0,1), prob = c(probproc_alt30_34w[,1],probproc_alt30_34w[,2]))
exp <- mcstoc(rgamma, type = "V", fit2_alt_30_34w$estimate[1], fit2_alt_30_34w$estimate[2], rtrunc = T, linf = 0, lsup = 500)
...
set.seed(1)
ifexp <- mcstoc(rempiricalD, values = c(0,1), prob = c(probproc35_39w[,1],probproc35_39w[,2]))
exp <- mcstoc(rgamma, type = "V", fit2_35_39w$estimate[1], fit2_35_39w$estimate[2], rtrunc = T, linf = 0, lsup = 500)
...
set.seed(1)
ifexp <- mcstoc(rempiricalD, values = c(0,1), prob = c(probproc_alt35_39w[,1],probproc_alt35_39w[,2]))
exp <- mcstoc(rgamma, type = "V", fit2_alt_35_39w$estimate[1], fit2_alt_35_39w$estimate[2], rtrunc = T, linf = 0, lsup = 500)
...
YLD <- pEffect * dw_diagnosis * time_diagnosis + #diagnosis
  ...
  pEffect * (1-fatal75_79w) * p_stoma * dw_stoma * (LE_75_79w - (77 + time_total_YLD)) #stoma
...
DALY100000_alt <- DALYtotal_alt/(pop_men+pop_women)*10^5
summary(DALY100000_alt)
...
tDALY_ref_proc_CRC <- DALYtotalref
summary(tDALY_ref_proc_CRC)


tDALY_alt_proc_CRC <- DALYtotal_alt
summary(tDALY_alt_proc_CRC)


tDALY_ref_proc_CRC_100000 <- tDALY_ref_proc_CRC/pop15_85_plus*1e+05
summary(tDALY_ref_proc_CRC_100000)


tDALY_alt_proc_CRC_100000 <- tDALY_alt_proc_CRC/pop15_85_plus*1e+05
summary(tDALY_alt_proc_CRC_100000)


dDALY_alt_proc_CRC <- tDALY_alt_proc_CRC - tDALY_ref_proc_CRC
summary(dDALY_alt_proc_CRC)

dDALY_alt_proc_CRC_100000 <- dDALY_alt_proc_CRC/pop15_85_plus*1e+05
summary(dDALY_alt_proc_CRC_100000)



##### Save #####

tDALY_ref_proc_CRC_unc <- apply(tDALY_ref_proc_CRC, 2, function(x) x*1) #get data out of mc2d
write.csv(tDALY_ref_proc_CRC_unc, "tDALY_ref_proc_CRC_unc.csv")

tDALY_alt_proc_CRC_matrix <- apply(tDALY_alt_proc_CRC, 2, function(x) x*1) #get data out of mc2d
tDALY_alt_proc_CRC_unc <- apply(tDALY_alt_proc_CRC_matrix, 2, function(x) mean(x)) #only uncertainty dimension
write.csv(tDALY_alt_proc_CRC_unc, "tDALY_alt_proc_CRC_unc.csv")
